(function ($, undefined) {
    ...
    function showRepo(repo) {
        var $item = $('<div class="col-lg-3 col-md-4 col-sm-6 repo ' + (repo.language || '').toLowerCase() + '" />');
    ...
    $.getJSON('https://api.github.com/users/' + userName + '/followers?callback=?', function (result) {
