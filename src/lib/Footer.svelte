<footer class="relative isolate overflow-hidden bg-gray-900 py-24 sm:py-32">
  <img
  ...
  <div class="mx-auto max-w-7xl px-6 lg:px-8">
    ...
    <div class="mx-auto mt-10 max-w-2xl lg:mx-0 lg:max-w-none">
      ...
      <div
        class="mt-10 grid grid-cols-1 gap-x-8 gap-y-6 text-base font-semibold leading-7 text-white sm:grid-cols-2 md:flex lg:gap-x-10"
      >
        <a href="/">Our story <span aria-hidden="true">&rarr;</span></a>
        <a href="/">Terms & Privacy <span aria-hidden="true">&rarr;</span></a>
        <a href="/">Abuse report <span aria-hidden="true">&rarr;</span></a>
      </div>
    </div>
  </div>
</footer>
